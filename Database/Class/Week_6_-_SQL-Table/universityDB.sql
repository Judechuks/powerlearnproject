...
-- populating the GPA column of the Students table, Assuming they all got 3.50
-- UPDATE students
-- SET GPA = 3.5
-- WHERE StudentID > 1000;

-- populating the GPA column of the Students table, Where Null values are replaced with 3.50
-- UPDATE Students
-- SET GPA = IFNULL(GPA, 3.5)
-- WHERE StudentID > 1000;
